        ...
        <div className="relative lg:max-w-md">
            ...
            <div className="hidden md:my-8 md:flex md:w-full md:items-center md:justify-evenly lg:justify-between">
                {images.map((image, index) => (
                    <div
                        key={image}
                        className={`rounded-xl ${index === currImg && 'outline outline-primary'
                            }`}
                    >
                        <img
                            src={image}
                            alt="shoes"
                            className={`w-32 rounded-lg transition-all duration-300 hover:cursor-pointer hover:opacity-40 lg:w-[88px] ${index === currImg && 'opacity-40'
                                }`}
